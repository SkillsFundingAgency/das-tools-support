...
public class EmployerCommitmentsService(ICommitmentsApiClient commitmentApi, IMapper mapper, ILogger<EmployerCommitmentsService> logger)
    : IEmployerCommitmentsService
{
    ...
    public async Task<StopApprenticeshipResult> StopApprenticeship(StopApprenticeshipRequest request, CancellationToken token)
    {
        try
        {
            ...
            {
                await commitmentApi.StopApprenticeship(request.ApprenticeshipId, new CommitmentsV2.Api.Types.Requests.StopApprenticeshipRequest
                {
            ...
            {
                await commitmentApi.UpdateApprenticeshipStopDate(request.ApprenticeshipId, new ApprenticeshipStopDateRequest
                {
                    AccountId = request.AccountId,
    ...
    public async Task<SearchApprenticeshipsResult> SearchApprenticeships(SearchApprenticeshipsRequest request, CancellationToken token)
    {
        try
        {
            ...
            var result = await commitmentApi.GetApprenticeships(new GetApprenticeshipsRequest
            {
            ...
            {
                Apprenticeships = mapper.Map<IEnumerable<GetApprenticeshipsResponse.ApprenticeshipDetailsResponse>, List<ApprenticeshipDto>>(result.Apprenticeships),
    ...
    public async Task<GetApprenticeshipResult> GetApprenticeship(long apprenticeshipId, CancellationToken token)
    {
        try
        {
            ...
            var result = await commitmentApi.GetApprenticeship(apprenticeshipId, token);

            return new GetApprenticeshipResult
            {
                Apprenticeship = mapper.Map<ApprenticeshipDto>(result)
            };
        }
    ...
    public async Task<PauseApprenticeshipResult> PauseApprenticeship(PauseApprenticeshipRequest request, CancellationToken token)
    {
        try
        {
            ...
            await commitmentApi.PauseApprenticeship(new CommitmentsV2.Api.Types.Requests.PauseApprenticeshipRequest
            {
                ApprenticeshipId = request.ApprenticeshipId,
                UserInfo = new UserInfo
                {
    ...
    public async Task<ResumeApprenticeshipResult> ResumeApprenticeship(ResumeApprenticeshipRequest request, CancellationToken token)
    {
        try
        {
            ...
            await commitmentApi.ResumeApprenticeship(new CommitmentsV2.Api.Types.Requests.ResumeApprenticeshipRequest
            {
                ApprenticeshipId = request.ApprenticeshipId,
                UserInfo = new UserInfo
                {
