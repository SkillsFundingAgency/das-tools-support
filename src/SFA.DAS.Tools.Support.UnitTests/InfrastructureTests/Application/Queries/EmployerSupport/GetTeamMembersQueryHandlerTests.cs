...
public class GetTeamMembersQueryHandlerTests
{
    ...
    GetTeamMembersResponse response,
    [Frozen] Mock<IToolsSupportApimService> mockApiClient,
    [Frozen] Mock<IEncodingService> encodingService,
    GetTeamMembersQueryHandler handler
  )
    {
        // Arrange
        ...
        mockApiClient.Setup(client => client.GetTeamMembers(accountId, It.IsAny<CancellationToken>()))
